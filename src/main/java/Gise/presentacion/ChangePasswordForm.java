...
import Gise.dominio.User; // Importa la clase User, que probablemente representa un usuario en el sistema.
import Gise.persistencia.UserDAO; // Importa la interfaz o clase UserDAO, que define o implementa el acceso a datos para la entidad User.
