...
import Gise.dominio.User;        // Clase que representa la entidad de usuario en el dominio de la aplicación.
import Gise.utils.PasswordHasher; // Clase utilitaria para el manejo seguro de contraseñas (hash, verificación).
